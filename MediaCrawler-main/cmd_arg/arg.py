...
async def parse_cmd(argv: Optional[Sequence[str]] = None):
    ...
    def main(
        ...
        enable_cdp_mode: Annotated[
            ...
            typer.Option(
                "--enable_cdp_mode",
                help="Whether to use CDP mode. Disable it to let Playwright launch a normal browser automatically.",
                rich_help_panel="Runtime Configuration",
                show_default=True,
            ),
        ...
        crawl_sleep_seconds: Annotated[
            float,
            typer.Option(
                "--crawl_sleep_seconds",
                help="Sleep seconds between crawler requests",
                rich_help_panel="Performance Configuration",
            ),
        ...
        config.CRAWLER_MAX_SLEEP_SEC = crawl_sleep_seconds
